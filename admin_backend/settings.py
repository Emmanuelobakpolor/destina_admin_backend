...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-4je_*^e8geokjq8#)(503c3fi2x9di)c@v$nlcg%@!ara-t106')
...
ALLOWED_HOSTS.append('destina-admin-backend.onrender.com')
